...
@Component({
  selector: 'app-column-rename',
  templateUrl: './column-rename.component.html',
  styleUrls: ['./column-rename.component.css']
})
export class ColumnRenameComponent implements OnInit {
  ...
  rename() {
    if (this.table && this.columnName) {
      this.tableService.renameColumn(this.connectionId, this.table, this.columnName, this.newName)
