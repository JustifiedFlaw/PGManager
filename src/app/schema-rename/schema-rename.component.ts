...
@Component({
  selector: 'app-schema-rename',
  templateUrl: './schema-rename.component.html',
  styleUrls: ['./schema-rename.component.css']
})
export class SchemaRenameComponent implements OnInit {
  ...
  rename() {
    if (this.schema) {
      this.schemaService.rename(this.connectionId, this.schema, this.newName)
